...
public class TableInsertStatistics {
	...
	HTable table;
	static byte[] tableName = TableSchemaDef.SCHEMA3_BIKE_TABLE_NAME.getBytes();//"Station_Statistics".getBytes();
	static byte[] idsFamily = TableSchemaDef.SCHEMA3_BIKE_FAMILY_NAME.getBytes();//"statistics".getBytes();
